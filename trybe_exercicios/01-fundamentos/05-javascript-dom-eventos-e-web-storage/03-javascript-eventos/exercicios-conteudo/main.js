...
function textBox() {
  const techElement = document.querySelector(".tech");
  techElement.innerText = document.getElementById("input").value;
}

input.addEventListener("keyup", textBox);
...
function changeColorReturn(event) {
  event.target.style.color = "white";
}
myWebpage.addEventListener("mouseout", changeColorReturn);
